...
echo "  facto pipeline create   # Start pipeline setup (chooser on agentic surfaces)"
echo "  facto pipeline create --x402            # Jump straight to Base x402"
echo "  facto pipeline create --monad-x402      # Jump straight to Monad x402"
echo "  facto pipeline create --mpp             # Jump straight to Monad MPP"
