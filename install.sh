...
echo "  facto pipeline create   # Create and authorize your Base payment pipeline"
echo "  facto services \"crypto\"  # Discover x402 services"
echo "  facto pay GET \"<url>\" --max-amount 0.001  # Execute one paid request"
echo ""
